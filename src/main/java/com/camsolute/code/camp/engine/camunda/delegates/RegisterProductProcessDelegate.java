...
public class RegisterProductProcessDelegate implements JavaDelegate {
	private static final Logger LOG = LogManager.getLogger(RegisterProductProcessDelegate.class);
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		if(!Util._IN_PRODUCTION) {
			_f = "[execute]";
			msg = "====[ registering product process: ]====";LOG.traceEntry(String.format(fmt,(_f+">>>>>>>>>").toUpperCase(),msg));
		}
